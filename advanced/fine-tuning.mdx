...
<Note>
  Fine-tuning job management is an **Enterprise** feature. JSONL export for self-managed fine-tuning is available on all plans.
</Note>
...
Enterprise customers can submit fine-tuning jobs directly from the platform:
