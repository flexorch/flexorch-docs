...
<CardGroup cols={2}>
  ...
  <Card title="PII detection & masking" icon="shield">
    46 PII types across TR, EU, and US jurisdictions. KVKK and GDPR compliant masking with full audit trail.
  </Card>
...
| **Pro** | 6,000 / month | Higher volume, BYO LLM API key, scheduled sync |
