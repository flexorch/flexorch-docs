...
One **credit** is consumed per processed document (one job = one credit). Dataset builds and exports do not consume credits.

Credit usage is tracked per billing period. The [Usage endpoint](/api-reference/usage) shows your current balance.
